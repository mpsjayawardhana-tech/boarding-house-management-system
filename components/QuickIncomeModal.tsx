...
import { INCOME_CATEGORIES } from '@/lib/financeConstants';
...
export function QuickIncomeModal({ isOpen, onClose }: QuickIncomeModalProps) {
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input 
                  ...
                  className="w-full p-3 rounded-xl border border-[#2a2d36] bg-black/40 text-white shadow-sm font-medium focus:border-emerald-500/50 focus:outline-none transition-colors"
                  required
                  autoFocus
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select 
                  ...
                  className="w-full p-3 rounded-xl border border-[#2a2d36] bg-black/40 text-white shadow-sm font-medium focus:border-emerald-500/50 focus:outline-none transition-colors appearance-none"
                  required
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input 
                    ...
                    className="w-full p-3 rounded-xl border border-[#2a2d36] bg-black/40 text-white shadow-sm font-medium focus:border-emerald-500/50 focus:outline-none transition-colors [color-scheme:dark]"
                    required
                  />
                </div>
                <div className="flex flex-col gap-1.5">
              ...
              <button type="submit" className="mt-4 bg-emerald-500 text-black px-6 py-3.5 rounded-xl font-bold shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:bg-emerald-400 transition-colors">
                Add Income
              </button>
            </form>
          </motion.div>
